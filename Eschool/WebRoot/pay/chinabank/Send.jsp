...
<%@ page import="com.changh.eschool.entity.Student"%>
...
String v_mid,key,v_url,v_oid,v_amount,v_moneytype,v_md5info;  //定义必须传递的参数变量
	...
	v_url = "http://wx.chuji8.com:8080/pay/chinabank/Receive.jsp";     // 商户自定义返回接收支付结果的页面
	  key = "lq9230u5rjasdkljfasdq23";									      // 如果您还没有设置MD5密钥请登陆我们为您提供商户后台，地址：https://merchant3.chinabank.com.cn/
...
//以上三项必须修改
	...
	v_amount=(String)request.getAttribute("tradeMoney");				// 订单金额                   
		v_moneytype ="CNY";	                  				// 币种
...
String remark1,remark2;
		...
		remark1 = (String)request.getAttribute("body");               //备注字段1
		remark2 = ((Student)session.getAttribute("student")).getStuUsername();               //备注字段2
