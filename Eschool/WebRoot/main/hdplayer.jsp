...
<body>
    <div class="l-top" style="">
        <div class="tps">
            把优异网校放入收藏夹，随时享受高清视频课程<input class="add-F" onclick=
            "AddFavorite(1)" type="submit" value="加入收藏" /><input class="add-x"
            onclick="Shortcut()" type="submit" value="放入桌面" /><a href=
            "javascript:void(0)" id="not-tips-fav" onclick=
            "AddFavorite(2)">不再提示</a>

            <form action="#" id=
            "Shortcut" target="_blank"></form>
        </div><a class="close" href="javascript:void(0)" onclick=
        "AddFavorite(0)">关闭</a>
    </div>
  ...
  <div class="harder">
    ...
    <div style="z-index: 999; position: relative;" class="logoFull">
        <div class="area">
            <div id="area-all">
                <ul>
                	<s:if test='#session.student==null'><li><a id='registbox' onclick='showRegbox()' title='注册网校会员' href='javascript:;'><span class='wn'>免费注册</span></a></li><li>|</li><li><a id='loginbox' onclick='ShowLogin()' title='登录网校' href='javascript:;'><span class='wn'>用户登录</span></a></li>
                    </s:if>
                    <s:else>
                    	<li style='color: #FFF;'><span class='wn'>hi,<s:property value='#session.student.stuUsername'/>&nbsp;&nbsp;<em title='安全退出，保护您的帐号安全'id='tuichu'>退出</em></span></li><li>|</li><li><a class='cblue3' target='_blank' href='/memberCenter/member.jsp'><span class='wn'><strong>会员中心</strong></span></a></li>
                    </s:else>
	...
	<div class="mulu">
        <div class="mulun">
            ...
            <div id="playerContent"></div>
                ...
                <div class="rightlist">
                    <div class="rtleft" style="display: none">
                        <a class="lstbot"></a><a class="close"></a>

                        <div class="rttop">
                            他们也在学该课程
                        </div>

                        <div class="rtgund" id="txue">
                            {同学}
                        </div>
                    </div>
                    ...
                    <div class="rtleft" style="display: none;">
                        ...
                        <div class="rtgund" id="jiaoliuqun">
                            {考试交流群}
                        </div>
                    </div>
                    ...
                    <div class="rtmulu">
                        ...
                        <s:if test="g.itemId==null">
                            <a href="/member/classroomHD?classId=${classDetail.classId}">高清视频</a>
                        </s:if>
                        <s:else>
                        	<a href="/member/classroomHD?classId=${g.itemId}_${classDetail.classId}">高清视频</a>
                        </s:else>
                        </div>
						<%--  
                        <div class="rtbot2" style="cursor: pointer;">
                        <s:if test="g.itemId==null">
                            <a href="/member/classroom?classId=${g.itemId}_${classDetail.classId}">三分视频</a>
                            </s:if>
                             <s:else>
                        	<a href="/member/classroom?classId=${g.itemId}_${classDetail.classId}">三分视频</a>
                        </s:else>
        ...
        <div class="submenu" style="display: none;">
            <div class="su_head">
                <span>记笔记</span><a class="close" href="javascript:;" onclick=
                "$('.submenu').hide()">关闭</a>
            </div>
            ...
            <div class="su_txt">
                ...
                <div class="submenu_y_3">
                    ...
                    "$('#ke-textarea').val('')">清空</a><a class="btn" href=
                    "javascript:;" onclick="AddNote()">提交</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div id="kmenu">
                    <ul>
                        ...
                        onmouseover="this.className='on'">
                            ...
                            "ShowBiji(0,'');"><span>学习笔记</span></a>

                            <div class="lnavp navlist biji">
                                <a class="notes1" href="javascript:;" onclick=
                                "ShowAddBiji()">记笔记</a> <a href="javascript:;"
                                onclick="ShowBiji(0,'');">查看笔记</a>
                            </div>
                        </li>

                        <li><a class="drill" href="javascript:;" id=
                        "lianxiurl">课后练习</a></li>

                        <li class="out2" onmouseout="this.className='out2'"
                        onmouseover="this.className='on2'">
                            <a href="javascript:void(0)" style=
                            "font-weight: bold;"><span>&nbsp;&nbsp;&nbsp;&nbsp;下&nbsp;载</span></a>

                            <div class="lnavp navlist biji">
                                <a class="btnx" href=
                                "javascript:notice('%E8%B4%AD%E4%B9%B0%E8%AF%BE%E7%A8%8B%E5%90%8E%E6%89%8D%E5%8F%AF%E4%B8%8B%E8%BD%BD%EF%BC%81',2);"
                                id="mp3url">音频课件</a> <a class="btnx" href=
                                "javascript:notice('%E8%B4%AD%E4%B9%B0%E8%AF%BE%E7%A8%8B%E5%90%8E%E6%89%8D%E5%8F%AF%E4%B8%8B%E8%BD%BD%EF%BC%81',2);"
                                id="jiangyiurl">本章讲义</a> <a class="btnx" href=
                                "javascript:;"
                                id="shoujiurl" target="_blank">手机视频</a>
                            </div>
                        </li>
                    </ul>
                </div><a class="mk-btn" href=
                "/search/UserCenter/examCenter/examlist.asp?ks=192" target=
                "_blank">在线模考</a> <a class="wen-btn" href="/memberCenter/addQuestion.jsp" id="hywd" target="_blank">你问我答</a>
                <div class="kTab2">
                    <a class="p-right" href="javascript:void(0)" title=
                    "点击观看下一讲课程" id="n_right">下一讲</a><a class="p-left" href=
                    "javascript:void(0)" title="点击观看上一讲课程" id="n_left">上一讲</a>
                </div>
            </div><br clear="all" />
        </div>
            ...
            <div class="ml-left">
                <div class="l-sub1" id="l-zl">
                    ...
                    <div class="colist_c" id="MyChapter">
                        <h3 id="liebieo"></h3>
                        <div class="contant copli" style=
                        "overflow: hidden; position: relative; padding: 0px;">
                            <div class="jscroll-c" style=
                            "top: -10px; z-index: 1200; position: relative; padding-right: 15px;">
                            ...
                            <div class="jscroll-e" style=
                            "height: 100%; top: 0px; right: 0pt; -moz-user-select: none; position: absolute; overflow: hidden; z-index: 9999; width: 15px; background: url(&quot;/main/images/s_bg2.png&quot;) repeat-y scroll right 0pt transparent;">
                            <div class="jscroll-u" style=
                            "position: absolute; top: 0px; width: 100%; left: 0pt; background: url(&quot;/main/images/s_bg2.png&quot;) repeat scroll 0pt 0pt transparent; overflow: hidden; height: 15px;">
                                </div>

                                <div class="jscroll-h" style=
                                "background: url(&quot;/main/images/s_bg2.png&quot;) repeat-y scroll -45px 0pt transparent; position: absolute; left: 0pt; -moz-user-select: none; border: 1px solid rgb(237, 115, 20); top: 16px; width: 13px; height: 70.6775px;">
                                </div>

                                <div class="jscroll-d" style=
                                "position: absolute; bottom: 0px; width: 100%; left: 0pt; background: url(&quot;/main/images/s_bg2.png&quot;) repeat scroll 0pt -15px transparent; overflow: hidden; height: 15px;">
                                </div>
                            </div>
                        </div>
                    </div>

                    <div class="colist_c" id="MyBiji" style=
                    "padding-top: 10px; display: none">
                        ...
                        <div class="feeds-list" style=
                        "text-align: center; margin: 30px 0px;"><img src=
                        "/main/images/loading24.gif" /></div>
                    </div>
                </div>
                ...
                <div class="l-sub1" id="xgkec">
                    ...
                    <div class="xgkc" style=
                    "text-align: center; margin: 10px 0px;"><img src=
                    "/main/images/loading24.gif" /></div>
                </div>
            ...
            <div class="ml-right">
                <div class="gmkcw gmkc" id="gmsc">
                    ...
                    <div class="tb-cart tb-action-hint" style="display: none;">
                        <a class="J_Close" href="javascript:;" onclick=
                        "$('.tb-cart').hide();" title="关闭">关闭</a>
                        ...
                        <div class="tb-txt">
                            ...
                            <p id="bid">购物车共有<strong id=
                            "kcnum">0</strong>个课程，合计：<strong class=
                            "tb-price">0</strong>元</p><span class=
                            "tb-skin"><a class="tb-long-btn" href="/cart/cartList"
                            target="_blank" title=
                            "去购课车结算">去购课车结算</a></span><span><a class="J_GuanBi"
                            href="javascript:;" onclick="$('.tb-cart').hide();"
                            title="再逛逛"></a></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="msdy" style='display:block;'>
                    <div class="mspic">
                        <a href="/search/teacher/s.asp?ID=148" target=
                        "_blank"><img src="http://www.youeclass.com${g.teacher.tchImgUrl}" /></a>
                    </div>
                    <div class="mstxt">
                ...
                <div class="box_con">
                    <div class="box_tt">
                        <strong>名师答疑</strong><a class="more" href=
                    ...
                    <div class="tabbox">
                        <ul>
                            <li class="on"><a href="javascript:;" onclick=
                            "ShowWendaList(-1)">全部</a></li>

                            <li><a href="javascript:;" onclick=
                            "ShowWendaList(1)">已解决</a></li>

                            <li><a href="javascript:;" onclick=
                            "ShowWendaList(0)">未解决</a></li>
                        </ul>
                    </div>

                    <div class="nwwd" style=
                    "text-align: center; margin: 30px 0px;"><img src=
                    "/main/images/loading24.gif" /></div>
                </div>
	...
	<iframe 
     ...
     <script  type="text/javascript">
		...
		var videotime = 0;
		var payflag = ${payflag};
		var param = "${g.itemId}"==""?"":"${g.itemId}_";
		var t_name="${g.teacher.tchName}";
		var phone = "${student.stuMobile}";
		var uname ="${student.stuUsername}";
		var isMaxthon = navigator.userAgent.indexOf("Maxthon")>-1;
		var artdialog;
	    $(document).ready(function() {
	    	if("${remainTimes}")
	    		notice("你还可以听课${remainTimes}次",3);
	    	//setInterval($.post("/member/keepOnline"),5*60*1000);
	    	if(uname==""){
	    		loginSate=0;
	    	}else{
	    		loginSate=1;
								...
								if(studyRecord.length>0){
									for(var i=0;i<studyRecord.length;i++){
										if(i==0){
											...
											html +="<li class='ico'>"+studyRecord[i].recordName+"<\/li><li>上次"+studyRecord[i].recordStartTime+"&nbsp;<a href='?gradeId="+gradeId+"&classId="+studyRecord[i].classId+"'>继续播放...<\/a><\/li>";
										}
									}
	...
	$(document).ready(function(){
		...
		$("#n_right").click(function(){
			if(nextdid!=0)
				window.location = "?gradeId="+gradeId+"&classId="+param+nextdid ;
			else 
				notice("没有下一讲了，请选择其它的课件学习！",3);   
		});
		$("#n_left").click(function(){
			if(lastdid!=0)				
				window.location = "?gradeId="+gradeId+"&classId="+param+lastdid ;
			else 
			...
			success: function (result){
				...
				if(result.length!=0)
				{
					...
					for (var i=0;i<result.length;i++){
								...
								playIcon=childHtml+='<li><a href="?classId='+param+result[i].classId+'" title="'+unescape(result[i].classTitle)+'" classId="'+result[i].classId+'" class="'+playIcon+'"  target="_self"><span>'+(parseInt(childListNO)<10?"0"+parseInt(childListNO):parseInt(childListNO))+'、'+lname+'</span>'+isFree+'</a></li>';
						if(childHtml==''){
	...
	function StartPlay()
	{
		examwplay = jwplayer("playerContent").setup({
			    flashplayer: 'http://www.youeclass.com/js/daliedu.swf',			   
			    'file':HaveDetailTF ,
				width: '100%',
				height: '100%',
				controlbar: 'bottom',
	...
	function userName(){
		//return "${student.stuName} ${student.stuMobile}";
		return "读啊啦啦12312312312";
	}
	//笔记
