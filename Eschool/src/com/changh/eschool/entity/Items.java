...
public class Items implements java.io.Serializable {
	...
	/** full constructor */
	public Items(Integer itemId, Integer orderId, Integer id,
			Integer productId, double itemOPrice, double itemRPrice,
			double itemSPrice, String itemName, Integer itemPType) {
		this.itemId = itemId;
	...
	// 2014.03.17 增加一个属性来记录补课卡选的课节的东西
