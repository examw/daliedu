...
//屏幕截图配置区
,snapscreenHost: '192.168.1.236'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
...
,toolbars:[["FullScreen","Source","Undo","Redo","InsertUnorderedList","InsertOrderedList","Unlink","Link","ClearDoc","SelectAll","Print","SearchReplace","Preview","|","PageBreak","InsertImage","scrawl","SnapScreen","music","Emotion","InsertFrame","Date","Time","WordImage","Horizontal","Anchor","Spechars","BlockQuote","HighlightCode","template","Bold","Italic","Underline","StrikeThrough","ForeColor","BackColor","Superscript","Subscript","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","touppercase","tolowercase","DirectionalityLtr","DirectionalityRtl","Indent","RemoveFormat","FormatMatch","AutoTypeSet","PastePlain","CustomStyle","Paragraph","RowSpacingBottom","RowSpacingTop","LineHeight","FontFamily","FontSize","ImageNone","ImageLeft","ImageRight","ImageCenter","Help","InsertTable","DeleteTable","MergeRight","MergeDown","SplittoRows","SplittoCols","SplittoCells","MergeCells","InsertCol","InsertRow","DeleteCol","DeleteRow","InsertParagraphBeforeTable","background"],[]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'fullscreen':'','source':'','undo':'','redo':'','insertunorderedlist':'','insertorderedlist':'','unlink':'','link':'','cleardoc':'','selectall':'','print':'','searchreplace':'','preview':'','|':'','pagebreak':'','insertimage':'','scrawl':'','snapscreen':'','music':'','emotion':'','insertframe':'','date':'','time':'','wordimage':'','horizontal':'','anchor':'','spechars':'','blockquote':'','highlightcode':'','template':'','bold':'','italic':'','underline':'','strikethrough':'','forecolor':'','backcolor':'','superscript':'','subscript':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','touppercase':'','tolowercase':'','directionalityltr':'','directionalityrtl':'','indent':'','removeformat':'','formatmatch':'','autotypeset':'','pasteplain':'','customstyle':'','paragraph':'','rowspacingbottom':'','rowspacingtop':'','lineheight':'','fontfamily':'','fontsize':'','imagenone':'','imageleft':'','imageright':'','imagecenter':'','help':'','inserttable':'','deletetable':'','mergeright':'','mergedown':'','splittorows':'','splittocols':'','splittocells':'','mergecells':'','insertcol':'','insertrow':'','deletecol':'','deleterow':'','insertparagraphbeforetable':'','background':'','':''}
...
,minFrameHeight:100 //编辑器最小高度,默认220,拖动时以这个为准
