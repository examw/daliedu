...
<body style="padding:2px;text-align:center;">
  <div id="layout1">
    ...
    <div position="top" width="41px"> 
    	<center>
    	<button class="l-button" onclick="submit()">确定</button>
    	</center>
    </div>
  </div>
<script type="text/javascript">
    ...
    function submit()
    {
    	...
    	$.ajax({
    		...
    		data:{"stuId":stuId,"pkgIds":pids.toString(),"gradeIds":gids.toString()},
    		error:function(){},
    		success:function(d){
    			LG.hideLoading();
    			if(d.ok)
    			{
    				$.ligerDialog.alert("操作成功",function(){parent.closeTab('chooseClass');});
    			}else{
