...
<body style="padding:2px;text-align:center;">
  <div id="layout1">
    ...
    <div id="layout2">
    	<div position="left" id="left" title="老师" style="height:440px;display:block;position: relative; overflow:auto;  ">
		<div>
            <ul id="teacher"></ul> 
    	</div> 
		<div id="button"></div>
...
<script type="text/javascript">
    ...
    function f_teacher(examId){
        ...
        manager = $("#teacher").ligerGetTreeManager(); 
     	data=tree2.getData();
        $("#button").append("<a style=\"margin:20px;float:left;border:#ccc solid 1px;padding:5px\" onclick=\"f_cancelSelect()\">取消选择</a>");
